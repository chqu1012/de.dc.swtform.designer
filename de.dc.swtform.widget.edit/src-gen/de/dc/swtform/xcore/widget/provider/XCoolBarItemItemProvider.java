 ...
 * @generated
 */
public class XCoolBarItemItemProvider extends XWidgetItemProvider {
	/**
	 ...
	 * @generated
	 */
	public XCoolBarItemItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/XCoolBarItem"));
	}
	...
	public String getText(Object object) {
		String label = ((XCoolBarItem)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_XCoolBarItem_type") :
			getString("_UI_XCoolBarItem_type") + " " + label;
	}
