...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>XTool Bar Item</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dc.swtform.xcore.widget.impl.XToolBarItemImpl#getSelectionListenerName <em>Selection Listener Name</em>}</li>
 *   <li>{@link de.dc.swtform.xcore.widget.impl.XToolBarItemImpl#isHasSelectionListener <em>Has Selection Listener</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XToolBarItemImpl extends XWidgetImpl implements XToolBarItem {
	/**
	...
	protected EClass eStaticClass() {
		return WidgetPackage.eINSTANCE.getXToolBarItem();
	}
	...
	public void setSelectionListenerName(String newSelectionListenerName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WidgetPackage.XTOOL_BAR_ITEM__SELECTION_LISTENER_NAME, oldSelectionListenerName, selectionListenerName));
	}
	...
	public void setHasSelectionListener(boolean newHasSelectionListener) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WidgetPackage.XTOOL_BAR_ITEM__HAS_SELECTION_LISTENER, oldHasSelectionListener, hasSelectionListener));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ISelectable.class) {
			switch (derivedFeatureID) {
				case WidgetPackage.XTOOL_BAR_ITEM__SELECTION_LISTENER_NAME: return WidgetPackage.ISELECTABLE__SELECTION_LISTENER_NAME;
				case WidgetPackage.XTOOL_BAR_ITEM__HAS_SELECTION_LISTENER: return WidgetPackage.ISELECTABLE__HAS_SELECTION_LISTENER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ISelectable.class) {
			switch (baseFeatureID) {
				case WidgetPackage.ISELECTABLE__SELECTION_LISTENER_NAME: return WidgetPackage.XTOOL_BAR_ITEM__SELECTION_LISTENER_NAME;
				case WidgetPackage.ISELECTABLE__HAS_SELECTION_LISTENER: return WidgetPackage.XTOOL_BAR_ITEM__HAS_SELECTION_LISTENER;
				default: return -1;
			}
		}
