...
/**
 * This is the item provider adapter for a {@link de.dc.swtform.xcore.widget.XMenuItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class XMenuItemItemProvider extends XWidgetItemProvider {
	/**
	 ...
	 * @generated
	 */
	public XMenuItemItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/XMenuItem"));
	}
	...
	public String getText(Object object) {
		String label = ((XMenuItem)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_XMenuItem_type") :
			getString("_UI_XMenuItem_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(XMenuItem.class)) {
			case WidgetPackage.XMENU_ITEM__SELECTION_LISTENER_NAME:
			case WidgetPackage.XMENU_ITEM__HAS_SELECTION_LISTENER:
