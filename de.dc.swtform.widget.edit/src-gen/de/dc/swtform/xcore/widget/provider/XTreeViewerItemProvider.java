 ...
 * @generated
 */
public class XTreeViewerItemProvider extends XViewerItemProvider {
	/**
	 ...
	 * @generated
	 */
	public XTreeViewerItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_XTreeViewer_showHeader_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_XTreeViewer_showHeader_feature", "_UI_XTreeViewer_type"),
				 WidgetPackage.eINSTANCE.getXTreeViewer_ShowHeader(),
				 true,
				 false,
				 false,
	...
	protected void addShowLinesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_XTreeViewer_showLines_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_XTreeViewer_showLines_feature", "_UI_XTreeViewer_type"),
				 WidgetPackage.eINSTANCE.getXTreeViewer_ShowLines(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WidgetPackage.eINSTANCE.getXTreeViewer_Columns());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/XTreeViewer"));
	}
	...
	public String getText(Object object) {
		String label = ((XTreeViewer)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_XTreeViewer_type") :
			getString("_UI_XTreeViewer_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WidgetPackage.eINSTANCE.getXTreeViewer_Columns(),
