...
/**
 * This is the item provider adapter for a {@link de.dc.swtform.xcore.widget.XTabFolder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class XTabFolderItemProvider extends XWidgetItemProvider {
	/**
	 ...
	 * @generated
	 */
	public XTabFolderItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WidgetPackage.eINSTANCE.getXTabFolder_Items());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/XTabFolder"));
	}
	...
	public String getText(Object object) {
		String label = ((XTabFolder)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_XTabFolder_type") :
			getString("_UI_XTabFolder_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(XTabFolder.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WidgetPackage.eINSTANCE.getXTabFolder_Items(),
