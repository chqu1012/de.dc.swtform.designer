...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getXLayout_MarginWidth(), theEcorePackage.getEIntegerObject(), "marginWidth", "0", 0, 1, XLayout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXLayout_MarginHeight(), theEcorePackage.getEIntegerObject(), "marginHeight", "0", 0, 1, XLayout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(xGridDataEClass, XGridData.class, "XGridData", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getXGridData_VerticalAlignment(), theEcorePackage.getEIntegerObject(), "verticalAlignment", "4", 0, 1, XGridData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridData_HorizontalAlignment(), theEcorePackage.getEIntegerObject(), "horizontalAlignment", "4", 0, 1, XGridData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridData_WidthHint(), theEcorePackage.getEIntegerObject(), "widthHint", "-1", 0, 1, XGridData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridData_HeightHint(), theEcorePackage.getEIntegerObject(), "heightHint", "-1", 0, 1, XGridData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getXGridData_HorizontalSpan(), theEcorePackage.getEIntegerObject(), "horizontalSpan", "1", 0, 1, XGridData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridData_VerticalSpan(), theEcorePackage.getEIntegerObject(), "verticalSpan", "1", 0, 1, XGridData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridData_GrabExcessHorizontalSpace(), theEcorePackage.getEBooleanObject(), "grabExcessHorizontalSpace", "true", 0, 1, XGridData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridData_GrabExcessVerticalSpace(), theEcorePackage.getEBooleanObject(), "grabExcessVerticalSpace", "false", 0, 1, XGridData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getXGridLayout_NumColumns(), theEcorePackage.getEIntegerObject(), "numColumns", "1", 0, 1, XGridLayout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridLayout_MakeColumnsEqualWidth(), theEcorePackage.getEBooleanObject(), "makeColumnsEqualWidth", "false", 0, 1, XGridLayout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridLayout_MarginLeft(), theEcorePackage.getEIntegerObject(), "marginLeft", "0", 0, 1, XGridLayout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridLayout_MarginTop(), theEcorePackage.getEIntegerObject(), "marginTop", "0", 0, 1, XGridLayout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridLayout_MarginRight(), theEcorePackage.getEIntegerObject(), "marginRight", "0", 0, 1, XGridLayout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getXGridLayout_MarginBottom(), theEcorePackage.getEIntegerObject(), "marginBottom", "0", 0, 1, XGridLayout.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
