...
public class ModelActionBarContributor
	...
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			ModelModelWizard wizard = new ModelModelWizard();
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ModelEditorPlugin.INSTANCE.getString("_UI_ModelEditor_menu"), "de.dc.swtform.xcore.modelMenuID");
