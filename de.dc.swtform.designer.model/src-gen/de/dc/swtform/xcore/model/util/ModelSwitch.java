...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.SWT_FORM: {
				SwtForm swtForm = (SwtForm)theEObject;
				T result = caseSwtForm(swtForm);
				if (result == null) result = caseXNamedElement(swtForm);
				if (result == null) result = caseXLayoutElement(swtForm);
				if (result == null) result = caseXLayoutDataElement(swtForm);
			...
			case ModelPackage.XNAMED_ELEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Swt Form</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Swt Form</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSwtForm(SwtForm object) {
		return null;
	}
