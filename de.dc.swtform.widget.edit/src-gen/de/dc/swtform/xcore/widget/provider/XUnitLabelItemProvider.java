...
/**
 * This is the item provider adapter for a {@link de.dc.swtform.xcore.widget.XUnitLabel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class XUnitLabelItemProvider extends XWidgetItemProvider {
	 ...
	 * @generated
	 */
	public XUnitLabelItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_XUnitLabel_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_XUnitLabel_value_feature", "_UI_XUnitLabel_type"),
				 WidgetPackage.eINSTANCE.getXUnitLabel_Value(),
				 true,
				 false,
				 false,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_XUnitLabel_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_XUnitLabel_unit_feature", "_UI_XUnitLabel_type"),
				 WidgetPackage.eINSTANCE.getXUnitLabel_Unit(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/XUnitLabel"));
	}
	...
	public String getText(Object object) {
		String label = ((XUnitLabel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_XUnitLabel_type") :
			getString("_UI_XUnitLabel_type") + " " + label;
	}
